...
function __devbox_prepare_completions
    ...
    set -l results (__devbox_perform_completion)
    __devbox_debug "Completion results: $results"
    ...
    set --global __devbox_comp_results $results[1..-2]
...
complete -c devbox -n '__devbox_prepare_completions' -f -a '$__devbox_comp_results'
