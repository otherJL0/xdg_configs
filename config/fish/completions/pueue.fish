...
complete -c pueue -n "__fish_seen_subcommand_from add" -s w -l working-directory -d 'Specify current working directory' -r
...
complete -c pueue -n "__fish_seen_subcommand_from add" -s V -l version -d 'Print version information'
...
complete -c pueue -n "__fish_seen_subcommand_from remove" -s V -l version -d 'Print version information'
...
complete -c pueue -n "__fish_seen_subcommand_from switch" -s V -l version -d 'Print version information'
...
complete -c pueue -n "__fish_seen_subcommand_from stash" -s V -l version -d 'Print version information'
...
complete -c pueue -n "__fish_seen_subcommand_from enqueue" -s V -l version -d 'Print version information'
...
complete -c pueue -n "__fish_seen_subcommand_from start" -s V -l version -d 'Print version information'
...
complete -c pueue -n "__fish_seen_subcommand_from restart" -s V -l version -d 'Print version information'
...
complete -c pueue -n "__fish_seen_subcommand_from pause" -s V -l version -d 'Print version information'
...
complete -c pueue -n "__fish_seen_subcommand_from kill" -s V -l version -d 'Print version information'
...
complete -c pueue -n "__fish_seen_subcommand_from send" -s V -l version -d 'Print version information'
...
complete -c pueue -n "__fish_seen_subcommand_from edit" -s V -l version -d 'Print version information'
...
complete -c pueue -n "__fish_seen_subcommand_from group" -s h -l help -d 'Print help information'
complete -c pueue -n "__fish_seen_subcommand_from group" -s V -l version -d 'Print version information'
...
complete -c pueue -n "__fish_seen_subcommand_from status" -s V -l version -d 'Print version information'
...
complete -c pueue -n "__fish_seen_subcommand_from log" -s j -l json -d 'Print the resulting tasks and output as json. By default only the last stdout/-err lines will be returned unless --full is provided. Take care, as the json cannot be streamed! If your logs are really huge, using --full can use all of your machine\'s RAM'
...
complete -c pueue -n "__fish_seen_subcommand_from log" -s V -l version -d 'Print version information'
...
complete -c pueue -n "__fish_seen_subcommand_from follow" -s V -l version -d 'Print version information'
...
complete -c pueue -n "__fish_seen_subcommand_from wait" -s V -l version -d 'Print version information'
...
complete -c pueue -n "__fish_seen_subcommand_from clean" -s V -l version -d 'Print version information'
...
complete -c pueue -n "__fish_seen_subcommand_from reset" -s V -l version -d 'Print version information'
complete -c pueue -n "__fish_seen_subcommand_from shutdown" -s h -l help -d 'Print help information'
complete -c pueue -n "__fish_seen_subcommand_from shutdown" -s V -l version -d 'Print version information'
...
complete -c pueue -n "__fish_seen_subcommand_from parallel" -s V -l version -d 'Print version information'
...
complete -c pueue -n "__fish_seen_subcommand_from completions" -s V -l version -d 'Print version information'
complete -c pueue -n "__fish_seen_subcommand_from help" -s h -l help -d 'Print help information'
complete -c pueue -n "__fish_seen_subcommand_from help" -s V -l version -d 'Print version information'
