...
function __hubble_prepare_completions
    ...
    set -l results (__hubble_perform_completion)
    __hubble_debug "Completion results: $results"
    ...
    set --global __hubble_comp_results $results[1..-2]
...
complete -c hubble -n '__hubble_prepare_completions' -f -a '$__hubble_comp_results'
